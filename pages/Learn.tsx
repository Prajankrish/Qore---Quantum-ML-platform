...
import { 
  ...
  Wand2, Target, Network, Check, Link as LinkIcon, Info
} from 'lucide-react';
    ...
    <div className="space-y-8 animate-fade-in pb-10">
                      ...
                      <div className="space-y-4">
                          ...
                          <div className="flex gap-2">
                              <Input 
                                ...
                                onKeyDown={e => e.key === 'Enter' && (interests.push(interestInput), setInterestInput(''))}
                              />
      ...
      {activeTab === 'labs' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 animate-fade-in">
              ...
              <div className="lg:col-span-4 space-y-6">
                  <Card title="Quantum Gate Palette" subtitle="Drag gates to build your circuit">
                      <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-3 gap-3">
                              <button 
                                  ...
                                  className="p-4 bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-xl font-bold text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all"
                              >
                                  H
                              ...
                              <button 
                                  ...
                                  className="p-4 bg-gradient-to-br from-pink-500 to-pink-600 text-white rounded-xl font-bold text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all"
                              >
                                  X
                              ...
                              <button 
                                  ...
                                  className="p-4 bg-gradient-to-br from-amber-500 to-amber-600 text-white rounded-xl font-bold text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all"
                              >
                                  Z
                          ...
                          <p className="text-xs text-slate-500 font-bold uppercase tracking-wider pt-2">Multi-Qubit Gates</p>
                          <button 
                                  ...
                                  <div className="flex items-center gap-2">
                                      ...
                                      <div className="flex-1 h-12 flex items-center gap-2 border-b-2 border-slate-300 dark:border-slate-600 relative">
                                          {circuit.map((gate, i) => (
                                              ...
                                              ) : gate.type !== 'CNOT' ? <div key={i} className="w-10 h-10" /> : null
                                          ))}
                                      </div>
                                  </div>
                              </div>
                          ...
                          <div className="space-y-4">
                              ...
                              <div className="space-y-2">
                                  {simResults.map((result, i) => (
                                      <div key={i} className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                          <span className="font-mono font-bold text-lg">{result.label}</span>
                              ...
                              {circuit.length > 0 && simResults.some(r => r.prob > 0 && r.prob < 1) && (
                                  <div className="p-4 bg-violet-50 dark:bg-violet-900/20 rounded-xl border border-violet-200 dark:border-violet-800">
                                      <div className="flex items-start gap-3">
                                          ...
                                          <div>
                                              <p className="font-bold text-violet-900 dark:text-violet-200">Superposition Detected!</p>
                                              <p className="text-xs text-violet-700 dark:text-violet-300">
                                                  Your circuit has created a quantum superposition - the qubit(s) exist in multiple states simultaneously until measured.
                                              </p>
                                          </div>
                                      </div>
                                  </div>
                              ...
                              {circuit.some(g => g.type === 'CNOT') && simResults.length > 0 && simResults[0].prob < 1 && (
                                  <div className="p-4 bg-pink-50 dark:bg-pink-900/20 rounded-xl border border-pink-200 dark:border-pink-800">
                                      <div className="flex items-start gap-3">
                                          <Network className="w-5 h-5 text-pink-600 mt-0.5" />
                                          <div>
                                              <p className="font-bold text-pink-900 dark:text-pink-200">Entanglement Active!</p>
                                              <p className="text-xs text-pink-700 dark:text-pink-300">
                                                  CNOT gate has entangled the qubits - measuring one instantly determines the other, regardless of distance.
                                              </p>
                                          </div>
                                      </div>
                                  </div>
                      ...
                      <div className="lg:col-span-4 space-y-6">
                         <div className="p-5 bg-blue-50 dark:bg-blue-900/20 rounded-2xl border border-blue-100 dark:border-blue-900/30">
                            ...
                            <div className="space-y-3">
                                {activeModule.relatedResources && activeModule.relatedResources.length > 0 ? activeModule.relatedResources.map((res, i) => (
                                    <a 
